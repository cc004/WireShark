    ...
    {
        {
            ...
            if (num50 != -1 && WiringWrapper.CheckMech(num48, num49, 10))
            {
                ...
                num55 *= num57;
                num56 *= num57;
                Projectile.NewProjectile(null, vector.X, vector.Y, num55, num56, type2, damage, knockBack, WiringWrapper.CurrentUser, 0f, 0f);
            }
        }
    }
}