    ...
    {
        {
            ...
            if (num134 != -1 && WiringWrapper.CheckMech(num129, num128, 30) && NPC.MechSpawn(num131, num132, num134) &&
                flag11)
            {
            ...
            if (num133 <= -1)
            {
                switch (num130)
                {
                    ...
                    case 50:
                    {
                        if (WiringWrapper.CheckMech(num129, num128, 30) && NPC.MechSpawn(num131, num132, 65))
                        {
                    ...
                    case 40:
                    {
                        if (WiringWrapper.CheckMech(num129, num128, 300))
                        {
